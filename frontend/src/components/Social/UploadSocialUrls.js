 ...
 * UploadSocialUrl.js
 * 
 * Get social photo urls from database (not yet implemented) and send 3 social photo urls
...
export default function UploadImage() {
  ...
  const saveUrl = (db) => {
    axios({
      url: 'http://localhost:3003/saveSocials',
      method: 'POST',
  ...
  useEffect(() => {
    const fetchImages = async () => {
      await 
      axios({
        url: "http://localhost:3003/getSocials",
        method: "GET",
